...
public class Disco {
	...
	/**
	 * Accedente de la imagen de portada del Disco (es un String porque recibe el
	 * nombre del archivo que va a llevar la imagen).
	 * 
	...
	/**
	 * Mutador de la imagen de portada del Disco (es un String porque recibe el
	 * nombre del archivo que va a llevar la imagen).
	 * 
